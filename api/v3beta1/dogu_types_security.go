...
//
// Deprecated: Security is only honored by the "legacy" deployment strategy. Helm-deployed dogus
// (Strategy=helm) configure container security via Values instead.

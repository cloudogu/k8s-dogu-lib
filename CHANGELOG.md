...
### Added
- [#9] Add constants for conditions
- [#9] Add print columns for conditions

### Changed
- [#9] Mark fields Status, RequeueTime, RequeuePhase and Health as deprecated

## [v2.9.0] - 2025-06-18
### Added
- [#7] Add new status field for current data volume size including a special status condition

## [v2.8.0] - 2025-05-22
### Added
- [#5] Add new field for minimal data volume size
### Changed
- [#5] mark dataVolumeSize as deprecated in favour of minDataVolumeSize
...
- [#149] Clarified escaping rules for running the operator locally
  (see [here](https://github.com/cloudogu/k8s-dogu-operator/tree/develop/docs/development/development_guide_en.md) or [here](.env.template))
...
- [#118] Make implicitly used init container images explicit and configurable
   ...
   - see the [operations docs](https://github.com/cloudogu/k8s-dogu-operator/tree/develop/docs/operations/installing_operator_into_cluster_en.md) for more information
...
## [v0.19.0] - 2022-12-22
### Added
- [#44] Support for expanding dogu volumes. For details see [volume expansion docs](https://github.com/cloudogu/k8s-dogu-operator/tree/develop/docs/operations/expand_volume_en.md).

## [v0.18.1] - 2022-12-20
### Fixed
- [#66] Fixes dogu upgrade problems of `official/scm` dogus and add a fallback strategy to execute pre-upgrade scripts
  - for a detailed discussion please see the [dogu upgrade docs](https://github.com/cloudogu/k8s-dogu-operator/tree/develop/docs/operations/dogu_upgrades_en.md).
...
- [#47] Execute Dogu pre-upgrade scripts in upgrade process. See [dogu upgrades](https://github.com/cloudogu/k8s-dogu-operator/tree/develop/docs/operations/dogu_upgrades_en.md).
- [#51] Execute Dogu post-upgrade scripts in upgrade process. See [dogu upgrades](https://github.com/cloudogu/k8s-dogu-operator/tree/develop/docs/operations/dogu_upgrades_en.md).
...
- [#43] Dogu resource has now a support mode, which leads the dogu pods to a freeze but running state.
  This is useful in cases where the dogu is in a restart loop. See [support mode](https://github.com/cloudogu/k8s-dogu-operator/tree/develop/docs/operations/dogu_support_mode_en.md)
  for more information.

## [v0.12.0] - 2022-09-29
### Added
- [#41] Fire events to the specific dogu resource when installing or deleting a dogu. See 
[event policy](https://github.com/cloudogu/k8s-dogu-operator/tree/develop/docs/development/event_policy_for_the_operator_en.md) for more information.
- [#40] Support dogu upgrades
  ...
  - for more information about requeueing and internal error handling [the docs on reconciliation](https://github.com/cloudogu/k8s-dogu-operator/tree/develop/docs/development/reconciliation_en.md)
...
installation. See [documentation](https://github.com/cloudogu/k8s-dogu-operator/tree/develop/docs/operations/edit_dogu_volume_data_en.md) for more details.
...
- [#2] Annotation `k8s-dogu-operator.cloudogu.com/ces-services` to Dogu-`Services` containing information of
  related CES services. For more information see [Annotations](https://github.com/cloudogu/k8s-dogu-operator/tree/develop/docs/operations/annotations_en.md).
...
- [#11] **Breaking Change ahead!** The secret containing the dogu registry data was split and renamed from 
  ...
  [here](https://github.com/cloudogu/k8s-dogu-operator/tree/develop/docs/operations/configuring_the_container_registry_en.md) and
  [here](https://github.com/cloudogu/k8s-dogu-operator/tree/develop/docs/operations/configuring_the_dogu_registry_en.md).
